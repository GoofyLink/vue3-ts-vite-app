...
<template>
  <dl>
    <dt class="icon-task-bark" :class="route.path=='/task' ? 'active':''" @click="gotoPage('/task')">
        <i></i>
        <p>任务</p>
    </dt>
    <dt class="icon-contract-bark" :class="route.path=='/contract' ? 'active':''" @click="gotoPage('contract')">
        <i></i>
        <p>合约</p>
    </dt>
    <dt class="icon-message-bark" :class="route.path=='/message' ? 'active':''" @click="gotoPage('message')"> 
        <i></i>
        <p>消息</p>
    </dt>
    <dt class="icon-my-bark" :class="route.path=='/my' ? 'active':''" @click="gotoPage('my')">
        <i></i>
        <p>我的</p>
    </dt>
  </dl>
